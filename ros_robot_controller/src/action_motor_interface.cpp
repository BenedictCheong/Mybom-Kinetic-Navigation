...
void msgCallback(const action_execution_msgs::Package::ConstPtr& msg)
{
	...
	*/
    ...
    //기상 후 음악틀
    else if (msg->data_list[0].data_value_list[0] == "7")
    {
        std::cout<< "7" <<std::endl;
        total_action = 2;
        val1.push_back(4);
    ...
    //기상 후 음악끄기
    else if (msg->data_list[0].data_value_list[0] == "8")
    {
        std::cout<< "8" <<std::endl;
        total_action = 2;
        val1.push_back(3);
    ...
    //기상 종료 후 뒤돌기
    else if (msg->data_list[0].data_value_list[0] == "9")
    {
        std::cout<< "9" <<std::endl;
        total_action = 1;
        val1.push_back(3);
    ...
    else if (msg->data_list[0].data_value_list[0] == "10")
    {
    ...
    //음악 후 화장실
    else if (msg->data_list[0].data_value_list[0] == "TO")
    {
    ...
    else if (msg->data_list[0].data_value_list[0] == "TC")
    {
